  ...
  return (
    <>
      <div className="content-box-1">
        <div className="desc">
          <div className="desc-lg">COLORDENTITY</div>
          <div className="desc-sm">
            스스로 맞는 컬러가 무엇인지 측정해 보거나
            <br />
            빅데이터를 기반으로 학습한 AI를 통해 측정할 수 있습니다.
          </div>
        </div>
      ...
      <div className="img-container">
        {buttonStatus === "self" ? (
          ...
          <img src={aiImg} className="button-img-ai" alt="img" />
        ) : (
          <></>
        )}
      </div>
      ...
      <div className="landing-section">
        ...
        <div className="landing-section-1">
          <Controller>
            <Scene pin={false} reverse duration={300} offset={-300}>
              <Timeline
                target={
                  <div className="person-thinking desc1">
                    내 얼굴 톤에 맞는 화장품이 뭔지 모르겠어요.
                    <img
                      src={landingFirst1}
                      className="landing-section1-img1"
                    />
                  </div>
                }
              >
          ...
          <Controller>
            <Scene pin={false} reverse duration={300} offset={-300}>
              <Timeline
                target={
                  <div className="person-thinking desc2">
                    톤그로라고 놀림 받았어요ㅠㅠ
                    <img
                      src={landingFirst2}
                      className="landing-section1-img2"
                    />
                  </div>
                }
              >
          ...
          <Controller>
            <Scene pin={false} reverse duration={300} offset={-300}>
              <Timeline
                target={
                  <div className="person-thinking desc3">
                    핑크립을 바르면 왜 이렇게 입술만 둥둥 떠보일까요?
                    <img
                      src={landingFirst3}
                      className="landing-section1-img3"
                    />
                  </div>
                }
              >
        ...
        <div className="landing-section-2">
          <Controller>
            <Scene duration="70%" triggerHook="onEnter">
              <Tween
                position="0"
                from={{
                  top: "0%",
              ...
              >
                <div className="section-container">
                  <div className="landing-section-text">
                    스스로 여러가지 색상표를 바꿔보며 <br /> 내 얼굴이 환하고
                    생기있어 보이는 색이 <br /> 무엇인지 골라보세요.
                  </div>
                  <img
                    src={browser}
                    className="landing-section-browser-img"
                    alt=""
                  />
          ...
          <Controller>
            <Scene duration="70%" triggerHook="onEnter">
              ...
              >
                <div className="section-container">
                  <div className="landing-section-text">
                    빅데이터 기반으로 학습한 AI를 토대로 <br /> 내 퍼스널 컬러
                    자동 진단을 받아보세요.
                  </div>
                  <img
                    src={browser}
          ...
          <Controller>
            <Scene duration="70%" triggerHook="onEnter">
              ...
              >
                <div className="section-container">
                  <div className="landing-section-text">
                    나와 같은 톤인 사람들과 함께 <br /> 메이크업, 의상 등 다양한
                    정보를 공유하세요.
                  </div>
                  <img
                    src={browser}
        ...
        <div className="landing-footer">
          ...
          <div className="info">
            ...
            <p>
              ...
              <a className="info-link" href="https://github.com/oyeon-kwon">
                Github
              </a>
              <span className="info-divider">|</span>
              <a className="info-link" href="https://o-yeon.tistory.com/">
                Blog
              </a>
            </p>
          </div>
          <div className="terms-container">
            <span className="terms" onClick={termsModalHandler}>
              이용약관
            </span>
            <span className="terms-divider">|</span>
            <span className="terms" onClick={privacyModalHandler}>
              개인정보처리방침
            </span>
          </div>
        </div>
      ...
      {isPrivacyOpen ? (
        <Privacy privacyModalHandler={privacyModalHandler} />
      ) : null}
    </>
  );
}
