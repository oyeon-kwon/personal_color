...
function Terms ( { termsModalHandler } ) {

  return (
    <>
    <div className='terms-background' onClick={termsModalHandler}>
        <div className='terms-body'>
            <div className='terms-body-info'>
                <span className='close-button' onClick={termsModalHandler} >&times;</span>
                <div className='terms-big-title'>이용약관</div>
                ...
                <div className='terms-medium-title'>제2장 회원가입</div>
                ...
                <div className='terms-small-title'>
                    제10조 회원의 아이디 및 비밀번호의 관리에 대한 의무
                </div>
                <div className='terms-desc'>
                ...
                <div className='terms-medium-title'>제3장 콘텐츠이용계약</div>
                ...
                <div className='terms-medium-title'>제4장 콘텐츠이용계약의 청약철회, 계약해제/해지 및 이용제한</div>

                <div className='terms-small-title'>
                    제26조 이용자의 청약철회와 계약해제/해지
                </div>
                <div className='terms-desc'>
                ...
                <div className='terms-medium-title'>제5장 과오금, 피해보상 등</div>
                ...
                <div className='terms-desc'>
                    "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다.                 </div>
                </div>
        </div>
    </div>
    </>
