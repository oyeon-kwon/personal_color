...
import { editPostData, storage, getPostData } from '../firebase/firebase';
    ...
    <>
      <div className='post-view-box'>
        <div className='post-box'>
          <select name='categories' id='category-select' onChange={handleChangeCategory} value={postInput.category}>
          ...
          <div className='post-content'>
            ...
            <Editor
              ...
              initialValue={postInput.content}
              init={{
                height: 500,
                menubar: false,
                plugins: [
